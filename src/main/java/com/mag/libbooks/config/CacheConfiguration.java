package com.mag.libbooks.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("LibBooks");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("LibBooks");
        ...
        config.getMapConfigs().put("com.mag.libbooks.domain.*", initializeDomainMapConfig(jHipsterProperties));
